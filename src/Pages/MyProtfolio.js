        ...
        <div>
            ...
            <div className=' w-3/4 md:flex md:justify-between md:items-center mx-auto mt-12'>
                <div className='md:w-2/4 w-full'>
                    ...
                    <p className='text-xl font-semibold mb-2'>Hello I am hasibul hasan from Rajshahi, Bangladesh.
                        I am studing National Univarsity Honors level.I have some skills in web development .I have a good skill an font and development
                        Backend also.Iam very much confident about react js.I am using some freamwork like Tailwind , Bootstrap
                    </p>
